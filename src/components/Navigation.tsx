...
const adminNavItems: NavItem[] = [
  { id: "overview", label: "Homepage", icon: <Home size={18} />, path: "#overview" },
  { id: "projects", label: "Projects", icon: <Lightbulb size={18} />, path: "#projects" },
  { id: "news", label: "News", icon: <Mail size={18} />, path: "#news" },
  { id: "subscribers", label: "Newsletter", icon: <Users size={18} />, path: "#subscribers" },
  { id: "proposals", label: "Proposals", icon: <Trophy size={18} />, path: "#proposals" },
  { id: "events", label: "Events", icon: <Calendar size={18} />, path: "#events" },
  { id: "messages", label: "Messages", icon: <Info size={18} />, path: "#messages" },
];
...
const Navigation = ({ isAdmin = false, onTabChange }: NavigationProps) => {
              ...
              {isAdmin ? (
                ...
                >
                  ...
                  >
                    ...
                    {/* Button content */}
                    <motion.div
                      className={`flex items-center gap-2 font-rajdhani font-semibold text-sm uppercase tracking-wide transition-colors duration-300 ${hoveredItem === item.id ? "text-primary" : "text-muted-foreground hover:text-foreground"
                        }`}
                    >
                      <motion.span
                        animate={{
                          color: hoveredItem === item.id ? "hsl(var(--primary))" : undefined,
                        }}
                      >
                        {item.icon}
                      </motion.span>
                ...
                <Link to={item.path}>
                  ...
                  >
                    ...
                    {/* Button content */}
                    <motion.div
                      className={`flex items-center gap-2 font-rajdhani font-semibold text-sm uppercase tracking-wide transition-colors duration-300 ${isActive(item.path) ? "text-primary" : "text-muted-foreground hover:text-foreground"
                        }`}
                    >
                      <motion.span
                        animate={{
